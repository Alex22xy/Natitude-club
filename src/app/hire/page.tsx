...
export default function HirePage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white p-6 pt-24 pb-40">
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleHireSubmit} className="space-y-12">
          <div className="space-y-8">
            <div className="group">
              <label className="text-[10px] uppercase tracking-widest text-zinc-600 group-focus-within:text-natitude-pink transition-colors">Identification</label>
              <input name="name" required placeholder="NAME / ORGANIZATION" className="w-full bg-transparent border-b border-white/10 py-4 outline-none focus:border-natitude-pink transition-colors text-xs uppercase tracking-widest" />
            </div>
            
            <div className="group">
              <label className="text-[10px] uppercase tracking-widest text-zinc-600 group-focus-within:text-natitude-pink transition-colors">Digital Path</label>
              <input name="email" type="email" required placeholder="EMAIL ADDRESS" className="w-full bg-transparent border-b border-white/10 py-4 outline-none focus:border-natitude-pink transition-colors text-xs uppercase tracking-widest" />
            </div>

            <div className="group">
              <label className="text-[10px] uppercase tracking-widest text-zinc-600 group-focus-within:text-natitude-pink transition-colors">The Brief</label>
              <textarea name="message" rows={4} required placeholder="DESCRIBE THE TRANSMISSION..." className="w-full bg-transparent border-b border-white/10 py-4 outline-none focus:border-natitude-pink transition-colors text-xs uppercase tracking-widest resize-none" />
            </div>
          </div>
      ...
      {/* SUCCESS OVERLAY (Matching Rituals Page) */}
      {showSuccess && (
